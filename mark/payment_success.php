...
// $utxnid = '1577603491598';
// $product_result  =  $conn->select_one_row("select productinfo from payment_details where txnid = '" . $utxnid . "'", true);

// print_r(var_dump($product_result));
// //  $pdata  =  explode("  ",$product_result['productinfo']);
