...
(13, 2, 'sdf3456345', 'asdf8768dfmb', 'fcc8b826cff5f42d5b9ddf752d9e9487', '2019-08-24 00:02:50', 1),
...
(42, 1, '', '', 'dfc1507c04902a117b2602f4d41a3569', '2019-08-20 20:34:23', 0),
...
(46, 21, '', '', 'dc5a5f50fd47b2574c6580f1dac20ad0', '2019-08-22 10:23:05', 0),
(47, 21, '', '', 'dc5a5f50fd47b2574c6580f1dac20ad0', '2019-08-22 10:23:05', 0),
(48, 21, '', '', 'dc5a5f50fd47b2574c6580f1dac20ad0', '2019-08-22 10:23:05', 0),
(49, 3, '', '', '3afb14867ac70cdcbe4b09915d5f8348', '2019-08-21 00:43:06', 0),
(50, 1, '', '', '8d6ed4678a4a7d7f3838e026748652f6', '2019-08-21 07:11:41', 0),
...
(62, 1, '', '', 'beb0d64969f54ccf7b2e952238fa5e31', '2019-08-21 19:22:57', 0),
(63, 22, '', '', 'e2c3cfe61afff954cab084581f4e22ca', '2019-08-21 19:24:07', 0),
(64, 1, '', '', '34c82acff77bace7282361fb101123de', '2019-08-21 22:51:47', 0),
(65, 2, '', '', '34f2c3ecc9a0513621084f0897d37d41', '2019-08-21 23:42:44', 1),
(66, 22, '', '', '1d391661c992f199f2d902c579f4f49d', '2019-08-22 07:52:08', 0),
(67, 1, '', '', 'f64f1aaa79ba01774a0a75a1de741b51', '2019-08-22 09:10:22', 0),
(68, 21, '', '', 'dc5a5f50fd47b2574c6580f1dac20ad0', '2019-08-22 10:23:05', 0),
(69, 21, '', '', 'd097319107e29bdd4d64592381a88ad4', '2019-08-22 13:26:54', 0),
(70, 24, '', '', '80a8bbce350e1efd195eac9d378090b9', '2019-08-22 14:20:37', 1),
(71, 1, '', '', '11a137900e3fd77556ae65ccc4b8b067', '2019-08-22 14:56:00', 0),
(72, 25, '', '', '7ec78760d4329b33385b4f69134d48a2', '2019-08-22 15:14:22', 1),
(73, 26, '', '', '6d7fdf3b16dcc1a051cf6b462ff5a0bc', '2019-08-22 20:21:49', 0),
(74, 1, '', '', '708972f73a5d7bd7b06505e3b994a05a', '2019-08-22 20:22:45', 0),
(75, 1, '', '', '13f9722e6364f749469e66bd8d236d0c', '2019-08-22 22:02:56', 1),
(76, 21, '', '', '0350172db7ee0e43260a67371b992495', '2019-08-23 01:04:12', 1);
...
(17, 8, 4, 0, 0, 'hello question2', 'op1', 'op2', 'op3', 'op4', 1, '2', '2019-08-20 22:25:03');
...
(1, 1, '2019-08-24 02:55:39', '2019-08-24 03:55:39', '2019-08-12 01:51:50', 1),
...
(4, 8, '2019-08-24 03:09:17', '2019-08-24 04:09:17', '2019-08-20 22:23:23', 1),
(5, 7, '2019-08-22 10:36:00', '2019-08-22 11:00:00', '2019-08-21 10:37:21', 1);
...
(1, 8, 1, '2019-08-24 22:45:53', '0000-00-00 00:00:00', '2019-08-24 22:45:53', 1),
(2, 8, 1, '2019-08-24 22:54:08', '0000-00-00 00:00:00', '2019-08-24 22:54:08', 1);
...
--
-- Stand-in structure for view `web_login_status`
-- (See below for the actual view)
--
CREATE TABLE `web_login_status` (
`user_id` int(8)
,`email` varchar(50)
,`month` varchar(20)
,`month_id` int(2)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `user_login_status`  AS  select `u`.`email` AS `email`,`a`.`user_id` AS `user_id`,`a`.`auth_key` AS `auth_key`,if(`a`.`active` <> 1,'offline','Active') AS `status` from (`auth` `a` left join `users` `u` on(`u`.`id` = `a`.`user_id`)) where `a`.`user_id` in (1,2,3,21) and `a`.`active` = 1 ;

-- --------------------------------------------------------

--
-- Structure for view `web_login_status`
--
DROP TABLE IF EXISTS `web_login_status`;
